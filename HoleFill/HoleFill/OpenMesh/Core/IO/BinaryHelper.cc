...
union ShortChar   { short int s;  unsigned char c[2]; }  sc;
union IntChar     { int i;        unsigned char c[4]; }  ic;
union FloatChar   { float f;      unsigned char c[4]; }  fc;
union DoubleChar  { double d;     unsigned char c[8]; }  dc;
