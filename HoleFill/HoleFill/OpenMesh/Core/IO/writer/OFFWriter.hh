...
#include"../../IO/exporter/BaseExporter.hh"
#include"../../IO/writer/BaseWriter.hh"
...
protected:
  ...
  bool write_ascii(FILE*, BaseExporter&, Options) const;
  bool write_binary(FILE*, BaseExporter&, Options) const;
};
