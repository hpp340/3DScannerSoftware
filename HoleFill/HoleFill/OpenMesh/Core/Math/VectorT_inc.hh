...
//     values_[0] = v0;
  ...
  inline vector_type& operator=(const vector_type& _rhs) {
    memcpy(this->values_, _rhs.values_, DIM*sizeof(Scalar));
    return *this;
  }
#endif
...
#undef expr
  ...
  inline Scalar* data() { return this->values_; }

  /// access to const Scalar array
  inline const Scalar*data() const { return this->values_; }
