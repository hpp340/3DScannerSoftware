...
QT_MOC_LITERAL(9, 104, 10)
    ...
    "MeshViewer\0setDrawModeWireframe\0\0"
    "setDrawModePoints\0openMesh\0saveMesh\0"
    "turnOnLight\0turnOffLight\0textureOn\0"
    "textureOff"
};
...
void MeshViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setDrawModeWireframe(); break;
        case 1: _t->setDrawModePoints(); break;
        case 2: _t->openMesh(); break;
        case 3: _t->saveMesh(); break;
        case 4: _t->turnOnLight(); break;
        case 5: _t->turnOffLight(); break;
        case 6: _t->textureOn(); break;
        case 7: _t->textureOff(); break;
        default: ;
        }
        ...
        {
            typedef void (MeshViewer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MeshViewer::setDrawModeWireframe)) {
                *result = 0;
            }
        }
        {
            typedef void (MeshViewer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MeshViewer::setDrawModePoints)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject MeshViewer::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_MeshViewer.data,
      qt_meta_data_MeshViewer,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void MeshViewer::setDrawModeWireframe()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void MeshViewer::setDrawModePoints()
{
