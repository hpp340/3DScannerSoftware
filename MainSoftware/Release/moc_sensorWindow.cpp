...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sensorWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 81, 5)
    ...
    "sensorWindow\0updateStatusBarToScan\0\0"
    "updateStatusBarToView\0updateStatusBarToAlign\0"
    "debug"
};
...
void sensorWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        sensorWindow *_t = static_cast<sensorWindow *>(_o);
        switch (_id) {
        case 0: _t->updateStatusBarToScan(); break;
        case 1: _t->updateStatusBarToView(); break;
        case 2: _t->updateStatusBarToAlign(); break;
...
const QMetaObject sensorWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sensorWindow.data,
      qt_meta_data_sensorWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sensorWindow.stringdata))
        return static_cast<void*>(const_cast< sensorWindow*>(this));
