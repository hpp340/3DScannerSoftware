...
private:
  ...
  bool read(FILE* _in, BaseImporter& _bi, Options& _opt ) const;
  bool read_ascii(FILE* _in, BaseImporter& _bi) const;
  bool read_binary(FILE* _in, BaseImporter& _bi, bool swap) const;
